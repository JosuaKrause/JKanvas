...
public class PointListBenchmark {
   ...
   * | configuration                            |            mean |              stddev |
   * +------------------------------------------+-----------------+---------------------+
   * | plist[count: 10000 gaps: 0 res: -1]      |     0.116760 ms | +/-     0.007868 ms |
   * | plist[count: 10000 gaps: 100 res: -1]    |     0.139840 ms | +/-     0.022382 ms |
   * | plist[count: 10000 gaps: 0 res: 6000]    |     0.070020 ms | +/-     0.005655 ms |
   * | plist[count: 10000 gaps: 100 res: 6000]  |     0.079240 ms | +/-     0.012820 ms |
   * | plist[count: 10000 gaps: 3000 res: 6000] |     0.067320 ms | +/-     0.004002 ms |
   * +------------------------------------------+-----------------+---------------------+
   * =============================
   * single array
   * =============================
